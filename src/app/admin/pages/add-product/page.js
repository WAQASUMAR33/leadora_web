                    ...
                    <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 1, mt: 1.5 }}>
                      {digitalTags.map((tag, idx) => (
                        <Chip
                          ...
                          sx={{ borderRadius: 0, bgcolor: '#F3F4FB', fontWeight: 600 }}
                        />
                      ))}
                    </Box>
                  </Box>
              ...
              <Paper square elevation={0} sx={{ p: 4, border: '1px solid #E5E7EB' }}>
                ...
                <Stack spacing={4}>
                  <Box>
                    ...
                    <Box sx={{ p: 3, bgcolor: '#F9FAFB', borderRadius: 0, border: '1px solid #E5E7EB' }}>
                  ...
                  <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', p: 2, bgcolor: '#F9FAFB', borderRadius: 0, border: '1px solid #E5E7EB' }}>
                    <Box>
