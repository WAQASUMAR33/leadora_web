    ...
    <Box sx={{ bgcolor: '#F9FAFB', minHeight: '100vh', p: { xs: 2, md: 4 } }}>
      ...
      <Box sx={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
        ...
        >
          <Grid container spacing={3}>
            ...
            <Grid item xs={12} lg={6}>
              <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5, mb: 3 }}>
                <Box sx={{ p: 1, bgcolor: '#DBEAFE', color: '#1D4ED8', display: 'flex' }}>
            ...
            <Grid item xs={12} lg={6}>
              ...
              >
                <CardContent sx={{ p: 3 }}>
                  <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5, mb: 3 }}>
                    <Box sx={{ p: 1, bgcolor: '#FEF3C7', color: '#B45309', display: 'flex' }}>
          ...
          <Box sx={{ mt: 6 }}>
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5, mb: 3 }}>
              <Box sx={{ p: 1, bgcolor: '#ECFDF5', color: '#059669', display: 'flex' }}>
